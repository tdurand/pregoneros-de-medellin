            ...
            // for (var i = 0; i < self.nbImages; i++) {
                ...
                if(self.get(i) === undefined) {
                    ...
                    var still = new Still({
                        ...
                        srcLowRes:"https://images.pregonerosdemedellin.com/data/"+self.pathToStills+"/lowres/way"+self.lpad(i, 3)+".jpg",
                        srcHighRes:"https://images.pregonerosdemedellin.com/data/"+self.pathToStills+"/highres/way"+self.lpad(i, 3)+".jpg"
                    });
