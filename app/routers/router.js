        ...
        route : function(route, name, callback) {
              ...
              Backbone.history.route(route, function(fragment) {
                ...
                if (_.isFunction(router.before)) {
                    ...
                    //This is the 2015 site, kept at /classic/. Phones and tablets
                    //go to the new app at /, which understands the same URLs.
                    //?desktop keeps them here, #mobile still shows the trailer.
